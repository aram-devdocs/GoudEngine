...
mod decomposition_tests {
    ...
    fn test_rotation_extraction() {
        ...
        let global =
            GlobalTransform::from_translation_rotation_scale(Vec3::zero(), original, Vec3::one());
    ...
    fn test_decompose() {
        ...
        let dot = original_r.x * r.x + original_r.y * r.y + original_r.z * r.z + original_r.w * r.w;
        assert!(dot.abs() > 0.999);
    }
