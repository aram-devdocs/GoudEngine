...
/// 0 on success, negative error code on failure.
#[no_mangle]
pub extern "C" fn goud_physics3d_set_timestep(ctx: GoudContextId, dt: f32) -> i32 {
...
/// 0 on success, negative error code on failure.
#[no_mangle]
pub unsafe extern "C" fn goud_physics3d_get_timestep(ctx: GoudContextId, out_dt: *mut f32) -> i32 {
    if out_dt.is_null() {
