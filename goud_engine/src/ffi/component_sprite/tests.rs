...
use crate::ffi::component_sprite::{
    ...
    properties::{
        ...
        goud_sprite_get_flip_y, goud_sprite_get_source_rect, goud_sprite_get_z_layer,
        goud_sprite_has_custom_size, goud_sprite_has_source_rect, goud_sprite_is_flipped,
        goud_sprite_set_anchor, goud_sprite_set_custom_size, goud_sprite_set_flip,
        goud_sprite_set_flip_x, goud_sprite_set_source_rect, goud_sprite_set_z_layer,
        goud_sprite_with_anchor, goud_sprite_with_custom_size, goud_sprite_with_flip_x,
