...
mod load_from_bytes {
    ...
    fn test_load_from_bytes_multiple_types() {
        ...
        let h2 = server.load_from_bytes::<TestTexture>("sprite.png", &[64, 0, 0, 0, 32, 0, 0, 0]);
...
mod dependency_integration {
    ...
    impl AssetLoader for DependentAssetLoader {
        ...
        fn load<'a>(
            ...
            // Declare a dependency on "base.test"
    ...
    fn test_manual_dependency_and_cascade() {
        ...
        // Manually add dependencies to test the graph integration
        server
