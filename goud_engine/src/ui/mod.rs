...
//! relationships and each node can carry a
//! [`UiComponent`](crate::ui::UiComponent) describing its
//! widget type.
//!
//! # Key Types
//!
//! - [`UiNodeId`](crate::ui::UiNodeId) -- generational identifier for a UI node
//! - [`UiNode`](crate::ui::UiNode) -- a single node in the tree
//! - [`UiComponent`](crate::ui::UiComponent) -- the widget variant attached to a node
//! - [`UiManager`](crate::ui::UiManager) -- owns and manages the full node tree
...
pub use layout::{
    PositionMode, UiAlign, UiAnchor, UiEdges, UiFlexDirection, UiFlexLayout, UiJustify, UiLayout,
};
