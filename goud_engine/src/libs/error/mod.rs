...
//!
//! This is the canonical Layer 1 location for error types, enabling
//! `libs/` modules to import errors without layer violations.
//!
//! # Error Code Ranges
//!
...
pub use codes::{
    ...
    ERR_PHYSICS_INIT_FAILED, ERR_PLATFORM_ERROR, ERR_PROVIDER_INIT_FAILED,
    ...
    GRAPHICS_ERROR_BASE, INPUT_ERROR_BASE, INTERNAL_ERROR_BASE, PROVIDER_ERROR_BASE,
    RESOURCE_ERROR_BASE, SUCCESS, SYSTEM_ERROR_BASE,
};
