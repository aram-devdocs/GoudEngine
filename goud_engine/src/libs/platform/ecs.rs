...
// use std::rc::Rc;
// use crate::types::{Sprite, EntityId};
...
//     pub fn add_sprite_component(&mut self, entity_id: EntityId, texture_path: &str, data: &Sprite) {
...
//     pub fn update_sprite_component(&mut self, entity_id: EntityId, data: &Sprite) {
