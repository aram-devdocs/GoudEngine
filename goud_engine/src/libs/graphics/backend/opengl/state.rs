...
impl RenderBackend for OpenGLBackend {
    ...
    fn set_clear_color(&mut self, r: f32, g: f32, b: f32, a: f32) {
        ...
        // SAFETY: GL context is active and valid; all four color components are finite f32 values.
        unsafe {
    ...
    fn clear_color(&mut self) {
        // SAFETY: GL context is active and valid; COLOR_BUFFER_BIT is a valid clear mask.
        unsafe {
    ...
    fn clear_depth(&mut self) {
        // SAFETY: GL context is active and valid; DEPTH_BUFFER_BIT is a valid clear mask.
        unsafe {
    ...
    fn set_viewport(&mut self, x: i32, y: i32, width: u32, height: u32) {
        // SAFETY: GL context is active and valid; width/height are cast from u32 which fits in i32 for valid viewports.
        unsafe {
    ...
    fn enable_depth_test(&mut self) {
        // SAFETY: GL context is active and valid; DEPTH_TEST is a valid capability constant.
        unsafe {
    ...
    fn enable_blending(&mut self) {
        // SAFETY: GL context is active and valid; BLEND is a valid capability and the blend factors are standard constants.
        unsafe {
            gl::Enable(gl::BLEND);
    ...
    fn disable_blending(&mut self) {
        // SAFETY: GL context is active and valid; BLEND is a valid capability constant.
        unsafe {
            gl::Disable(gl::BLEND);
        }
    }
    ...
    fn set_blend_func(&mut self, src: BlendFactor, dst: BlendFactor) {
        ...
        // SAFETY: GL context is active; src_gl and dst_gl are valid GL blend factor enums from conversions.
        unsafe {
    ...
    fn enable_culling(&mut self) {
        // SAFETY: GL context is active and valid; CULL_FACE is a valid capability constant.
        unsafe {
    ...
    fn set_cull_face(&mut self, face: CullFace) {
        ...
        // SAFETY: GL context is active; gl_face is a valid GL cull-face enum derived from the CullFace variant.
        unsafe {
            gl::CullFace(gl_face);
        }
    }
