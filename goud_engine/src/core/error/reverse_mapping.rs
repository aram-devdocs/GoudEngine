...
use super::codes::{
    ...
    ERR_PHYSICS_INIT_FAILED, ERR_PLATFORM_ERROR, ERR_PROVIDER_OPERATION_FAILED, ERR_QUERY_FAILED,
    ERR_RENDER_TARGET_FAILED, ERR_RESOURCE_ALREADY_EXISTS, ERR_RESOURCE_INVALID_FORMAT,
    ERR_RESOURCE_LOAD_FAILED, ERR_RESOURCE_NOT_FOUND, ERR_SCRIPT_ERROR,
...
impl GoudError {
    ...
    pub fn from_error_code(code: GoudErrorCode) -> Option<Self> {
        match code {
            ...
            ERR_PROVIDER_OPERATION_FAILED => Some(GoudError::ProviderError {
                subsystem: "unknown",
                message: String::new(),
            }),

            // Script errors (800-899)
            ERR_SCRIPT_ERROR => Some(GoudError::ScriptError(String::new())),
