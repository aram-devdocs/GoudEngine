...
[![total downloads](https://img.shields.io/badge/total_downloads-10%2C900-brightgreen)](#downloads)
...
|----------|-----------------|
| crates.io | [46](https://crates.io/crates/goud-engine) |
| NuGet | [2,689](https://www.nuget.org/packages/GoudEngine/) |
| PyPI | [5,856](https://pypi.org/project/goudengine/) |
| npm | [2,309](https://www.npmjs.com/package/goudengine) |
...
<sub>Last updated: 2026-06-04 via [GitHub Action](.github/workflows/community-stats.yml)</sub>
<!-- COMMUNITY-STATS:END -->
