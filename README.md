...
[![total downloads](https://img.shields.io/badge/total_downloads-12%2C434-brightgreen)](#downloads)
...
|----------|-----------------|
| crates.io | [65](https://crates.io/crates/goud-engine) |
| NuGet | [3,018](https://www.nuget.org/packages/GoudEngine/) |
| PyPI | [6,701](https://pypi.org/project/goudengine/) |
| npm | [2,650](https://www.npmjs.com/package/goudengine) |
...
<sub>Last updated: 2026-09-14 via [GitHub Action](.github/workflows/community-stats.yml)</sub>
<!-- COMMUNITY-STATS:END -->
