...
while [[ "$#" -gt 0 ]]; do
    ...
    -h|--help)
        ...
        echo "  --sdk <type>     SDK type: csharp, cpp, go, lua, python, rust, typescript (default: csharp)"
...
# Validate SDK type
case $SDK_TYPE in
"csharp" | "cpp" | "go" | "lua" | "python" | "rust" | "typescript")
    ;;
*)
    echo "Error: Invalid SDK type. Choose from: csharp, cpp, go, lua, python, rust, typescript"
    exit 1
    ;;
esac
