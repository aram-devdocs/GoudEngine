...
while [[ "$#" -gt 0 ]]; do
    ...
    -h|--help)
        ...
        echo "  --sdk <type>     SDK type: csharp, cpp, go, python, rust, swift, typescript (default: csharp)"
...
# Validate SDK type
case $SDK_TYPE in
"csharp" | "cpp" | "go" | "python" | "rust" | "swift" | "typescript")
    ;;
*)
    echo "Error: Invalid SDK type. Choose from: csharp, cpp, go, python, rust, swift, typescript"
    exit 1
    ;;
esac
