...
def gen_web_wrapper():
    ...
    lines.append("  get_render_stats(): { draw_calls: number; triangles: number; texture_binds: number; shader_binds: number } | undefined;")
    ...
    lines.append("    return { drawCalls: s.draw_calls, triangles: s.triangles, textureBinds: s.texture_binds, shaderBinds: s.shader_binds };")
    lines.append("  }")
    lines.append("")
