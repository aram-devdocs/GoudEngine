...
def gen_web_wrapper():
    ...
    lines.append("  physicsRaycastEx(_originX: number, _originY: number, _dirX: number, _dirY: number, _maxDist: number, _layerMask: number): IPhysicsRaycastHit2D | null { throw new Error('Not supported in WASM mode'); }")
    ...
    lines.append("  physicsCollisionEventsRead(_index: number): IPhysicsCollisionEvent2D | null { throw new Error('Not supported in WASM mode'); }")
