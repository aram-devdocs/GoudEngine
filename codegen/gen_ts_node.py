...
use goud_engine::ffi::physics::{
    ...
    goud_physics_add_rigid_body_ex, goud_physics_create_joint, goud_physics_remove_joint,
    goud_physics_apply_force, goud_physics_apply_impulse, goud_physics_collision_event_count,
    goud_physics_collision_event_read, goud_physics_collision_events_count, goud_physics_collision_events_read,
    ...
    goud_physics_get_collider_restitution, goud_physics_get_gravity,
    goud_physics_get_position, goud_physics_get_timestep, goud_physics_get_velocity,
    goud_physics_raycast, goud_physics_raycast_ex, goud_physics_remove_body, goud_physics_set_body_gravity_scale,
    goud_physics_set_collider_friction, goud_physics_set_collider_restitution,
    goud_physics_set_collision_callback, goud_physics_set_gravity,
    goud_physics_set_timestep, goud_physics_set_velocity, goud_physics_step,
    goud_physics3d_create, goud_physics3d_destroy, goud_physics3d_set_gravity,
    goud_physics3d_add_rigid_body, goud_physics3d_add_collider, goud_physics3d_remove_body,
    goud_physics3d_step, goud_physics3d_get_position, goud_physics3d_set_velocity,
    goud_physics3d_apply_force, goud_physics3d_apply_impulse, goud_physics3d_get_gravity,
    goud_physics3d_set_body_gravity_scale, goud_physics3d_get_body_gravity_scale,
    goud_physics3d_set_collider_friction, goud_physics3d_get_collider_friction,
    goud_physics3d_set_collider_restitution, goud_physics3d_get_collider_restitution,
    goud_physics3d_set_timestep, goud_physics3d_get_timestep,
};
...
impl GoudGame {
    ...
    #[napi]
    pub fn physics_collision_events_read(&self, index: u32) -> Result<Option<NapiPhysicsCollisionEvent2D>> {
...
impl NativePhysicsWorld2D {
    ...
    pub fn new(gravity_x: f64, gravity_y: f64, backend: Option<u32>) -> Result<Self> {
        ...
        Ok(Self { context_id, destroyed: false })
    }
    ...
    pub fn create_with_backend(&self, gravity_x: f64, gravity_y: f64, backend: u32) -> i32 {
        // SAFETY: context_id is valid and all parameters are plain values.
        unsafe { goud_physics_create_with_backend(self.context_id, gravity_x as f32, gravity_y as f32, backend) }
    }
    ...
    pub fn add_rigid_body(&self, body_type: u32, x: f64, y: f64, gravity_scale: f64) -> f64 {
        unsafe { goud_physics_add_rigid_body(self.context_id, body_type, x as f32, y as f32, gravity_scale as f32) as f64 }
    }

    #[napi]
    pub fn add_rigid_body_ex(&self, body_type: u32, x: f64, y: f64, gravity_scale: f64, ccd_enabled: bool) -> f64 {
        unsafe {
    ...
    pub fn get_position(&self, handle: f64) -> crate::types::Vec2 {
        ...
        let mut y = 0.0f32;
        // SAFETY: Passing valid mutable references as out-pointers.
        let _ = unsafe { goud_physics_get_position(self.context_id, handle as u64, &mut x, &mut y) };
        crate::types::Vec2 { x: x as f64, y: y as f64 }
    }
    ...
    pub fn get_velocity(&self, handle: f64) -> crate::types::Vec2 {
        ...
        let mut y = 0.0f32;
        // SAFETY: Passing valid mutable references as out-pointers.
        let _ = unsafe { goud_physics_get_velocity(self.context_id, handle as u64, &mut x, &mut y) };
        crate::types::Vec2 { x: x as f64, y: y as f64 }
    }
    ...
    #[napi]
    pub fn raycast(&self, origin_x: f64, origin_y: f64, dir_x: f64, dir_y: f64, max_dist: f64) -> crate::types::Vec2 {
        ...
        crate::types::Vec2 { x: hit_x as f64, y: hit_y as f64 }
    }
    ...
    pub fn collision_events_read(&self, index: u32) -> NapiPhysicsCollisionEvent2D {
        ...
        let mut kind: u32 = 0;
        // SAFETY: Passing valid mutable references as out-pointers.
        let _ = unsafe { goud_physics_collision_events_read(self.context_id, index, &mut body_a, &mut body_b, &mut kind) };
        NapiPhysicsCollisionEvent2D { body_a: body_a as f64, body_b: body_b as f64, kind }
    }
    ...
    pub fn collision_event_read(&self, index: u32) -> NapiPhysicsCollisionEvent2D {
        ...
        let mut kind: u32 = 0;
        // SAFETY: Passing valid mutable references as out-pointers.
        let _ = unsafe { goud_physics_collision_event_read(self.context_id, index, &mut body_a, &mut body_b, &mut kind) };
        NapiPhysicsCollisionEvent2D { body_a: body_a as f64, body_b: body_b as f64, kind }
    }
    ...
    pub fn set_collision_callback(&self, callback_ptr: f64, user_data: f64) -> Result<i32> {
        ...
        Ok(goud_physics_set_collision_callback(self.context_id, None, std::ptr::null_mut()))
    }
    ...
    pub fn get_body_gravity_scale(&self, handle: f64) -> f64 {
        ...
        let _ = unsafe { goud_physics_get_body_gravity_scale(self.context_id, handle as u64, &mut out_scale) };
        out_scale as f64
    }

    #[napi]
    pub fn set_collider_friction(&self, handle: f64, friction: f64) -> i32 {
        unsafe { goud_physics_set_collider_friction(self.context_id, handle as u64, friction as f32) }
    }
    ...
    pub fn get_collider_friction(&self, handle: f64) -> f64 {
        ...
        // SAFETY: Passing valid mutable reference as out-pointer.
        let _ = unsafe { goud_physics_get_collider_friction(self.context_id, handle as u64, &mut out_friction) };
        out_friction as f64
    }

    #[napi]
    pub fn set_collider_restitution(&self, handle: f64, restitution: f64) -> i32 {
        unsafe { goud_physics_set_collider_restitution(self.context_id, handle as u64, restitution as f32) }
    }
    ...
    pub fn get_collider_restitution(&self, handle: f64) -> f64 {
        ...
        // SAFETY: Passing valid mutable reference as out-pointer.
        let _ = unsafe { goud_physics_get_collider_restitution(self.context_id, handle as u64, &mut out_restitution) };
...
impl NativePhysicsWorld3D {
    ...
    pub fn new(gravity_x: f64, gravity_y: f64, gravity_z: f64) -> Result<Self> {
        ...
        // SAFETY: context_id is valid and all parameters are plain values.
        let status = unsafe {
            goud_physics3d_create(context_id, gravity_x as f32, gravity_y as f32, gravity_z as f32)
        };
        if status != 0 {
            let _ = goud_context_destroy(context_id);
            return Err(Error::from_reason(format!(
    ...
    pub fn create(&self, gravity_x: f64, gravity_y: f64, gravity_z: f64) -> i32 {
        unsafe { goud_physics3d_create(self.context_id, gravity_x as f32, gravity_y as f32, gravity_z as f32) }
    }
    ...
    #[napi]
    pub fn add_rigid_body(&self, body_type: u32, x: f64, y: f64, z: f64, gravity_scale: f64) -> f64 {
        unsafe {
    ...
    pub fn get_position(&self, handle: f64) -> crate::types::Vec3 {
        ...
        let mut z = 0.0f32;
        // SAFETY: Passing valid mutable references as out-pointers.
        let _ = unsafe { goud_physics3d_get_position(self.context_id, handle as u64, &mut x, &mut y, &mut z) };
        crate::types::Vec3 { x: x as f64, y: y as f64, z: z as f64 }
    }

    #[napi]
    pub fn set_velocity(&self, handle: f64, vx: f64, vy: f64, vz: f64) -> i32 {
        unsafe { goud_physics3d_set_velocity(self.context_id, handle as u64, vx as f32, vy as f32, vz as f32) }
    }

    #[napi]
    pub fn apply_force(&self, handle: f64, fx: f64, fy: f64, fz: f64) -> i32 {
        unsafe { goud_physics3d_apply_force(self.context_id, handle as u64, fx as f32, fy as f32, fz as f32) }
    }

    #[napi]
    pub fn apply_impulse(&self, handle: f64, ix: f64, iy: f64, iz: f64) -> i32 {
        unsafe { goud_physics3d_apply_impulse(self.context_id, handle as u64, ix as f32, iy as f32, iz as f32) }
    }
    ...
    #[napi]
    pub fn set_body_gravity_scale(&self, handle: f64, scale: f64) -> i32 {
        unsafe { goud_physics3d_set_body_gravity_scale(self.context_id, handle as u64, scale as f32) }
    }
    ...
    pub fn get_body_gravity_scale(&self, handle: f64) -> f64 {
        let mut out_scale = 0.0f32;
        // SAFETY: Passing valid mutable reference as out-pointer.
        let _ = unsafe { goud_physics3d_get_body_gravity_scale(self.context_id, handle as u64, &mut out_scale) };
        out_scale as f64
    }

    #[napi]
    pub fn set_collider_friction(&self, handle: f64, friction: f64) -> i32 {
        unsafe { goud_physics3d_set_collider_friction(self.context_id, handle as u64, friction as f32) }
    }
    ...
    pub fn get_collider_friction(&self, handle: f64) -> f64 {
        let mut out_friction = 0.0f32;
        // SAFETY: Passing valid mutable reference as out-pointer.
        let _ = unsafe { goud_physics3d_get_collider_friction(self.context_id, handle as u64, &mut out_friction) };
        out_friction as f64
    }

    #[napi]
    pub fn set_collider_restitution(&self, handle: f64, restitution: f64) -> i32 {
        unsafe { goud_physics3d_set_collider_restitution(self.context_id, handle as u64, restitution as f32) }
    }
    ...
    pub fn get_collider_restitution(&self, handle: f64) -> f64 {
        let mut out_restitution = 0.0f32;
        // SAFETY: Passing valid mutable reference as out-pointer.
        let _ = unsafe { goud_physics3d_get_collider_restitution(self.context_id, handle as u64, &mut out_restitution) };
        out_restitution as f64
    }
...
impl NativeEngineConfig {
    ...
    pub fn set_physics_backend_2d(&self, backend: u32) -> bool {
        if self.handle.is_null() { return false; }
        // SAFETY: handle is valid.
        unsafe { goud_engine::ffi::engine_config::goud_engine_config_set_physics_backend_2d(self.handle, backend) }
    }
