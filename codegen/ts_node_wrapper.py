...
NATIVE_KNOWN_METHODS = {
    ...
    "render3D",
    "setFrustumCullingEnabled", "setSkinningMode", "setMaterialSortingEnabled",
    "setAnimationLodEnabled", "setSharedAnimationEval",
    "getDrawCalls", "getVisibleObjectCount", "getCulledObjectCount",
