...
def _setup():
    ...
    _lib.goud_text_new.restype = ctypes.c_uint64
    _lib.goud_text_default.argtypes = []
    _lib.goud_text_default.restype = ctypes.c_uint64
    _lib.goud_text_set_font_size.argtypes = [ctypes.c_uint64, ctypes.c_float]
    _lib.goud_text_set_font_size.restype = None
    _lib.goud_text_get_font_size.argtypes = [ctypes.c_uint64]
    _lib.goud_text_get_font_size.restype = ctypes.c_float
    _lib.goud_text_set_color.argtypes = [ctypes.c_uint64, ctypes.c_float, ctypes.c_float, ctypes.c_float, ctypes.c_float]
    _lib.goud_text_set_color.restype = None
    _lib.goud_text_get_color_r.argtypes = [ctypes.c_uint64]
    _lib.goud_text_get_color_r.restype = ctypes.c_float
    _lib.goud_text_get_color_g.argtypes = [ctypes.c_uint64]
    _lib.goud_text_get_color_g.restype = ctypes.c_float
    _lib.goud_text_get_color_b.argtypes = [ctypes.c_uint64]
    _lib.goud_text_get_color_b.restype = ctypes.c_float
    _lib.goud_text_get_color_a.argtypes = [ctypes.c_uint64]
    _lib.goud_text_get_color_a.restype = ctypes.c_float
    _lib.goud_text_set_alignment.argtypes = [ctypes.c_uint64, ctypes.c_uint8]
    _lib.goud_text_set_alignment.restype = None
    _lib.goud_text_get_alignment.argtypes = [ctypes.c_uint64]
    _lib.goud_text_get_alignment.restype = ctypes.c_uint8
    _lib.goud_text_set_max_width.argtypes = [ctypes.c_uint64, ctypes.c_float]
    _lib.goud_text_set_max_width.restype = None
    _lib.goud_text_clear_max_width.argtypes = [ctypes.c_uint64]
    _lib.goud_text_clear_max_width.restype = None
    _lib.goud_text_get_max_width.argtypes = [ctypes.c_uint64]
    _lib.goud_text_get_max_width.restype = ctypes.c_float
    _lib.goud_text_has_max_width.argtypes = [ctypes.c_uint64]
    _lib.goud_text_has_max_width.restype = ctypes.c_bool
    _lib.goud_text_set_line_spacing.argtypes = [ctypes.c_uint64, ctypes.c_float]
    _lib.goud_text_set_line_spacing.restype = None
    _lib.goud_text_get_line_spacing.argtypes = [ctypes.c_uint64]
