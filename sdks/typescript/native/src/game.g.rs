...
use goud_engine::ffi::debug::{
    ...
    goud_render_get_metrics, GoudDebuggerStepKind, GoudMemoryCategoryStats, GoudMemorySummary,
};
...
use goud_engine::ffi::renderer::{
    ...
    goud_renderer_draw_text, goud_renderer_draw_text_batch, goud_renderer_enable_blending,
    goud_renderer_enable_depth_test, goud_renderer_end, goud_renderer_get_stats,
    goud_renderer_set_viewport, goud_texture_destroy, goud_texture_load, FfiSpriteCmd, FfiTextCmd,
    GoudRenderStats,
};
...
impl GoudGame {
    ...
    pub fn draw_text_batch(&self, cmds: Vec<NapiTextCmd>) -> u32 {
        ...
        unsafe {
            goud_renderer_draw_text_batch(self.context_id, ffi_cmds.as_ptr(), ffi_cmds.len() as u32)
        }
    }
