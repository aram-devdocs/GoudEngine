...
export declare const enum RecoveryClass {
  Recoverable = 0,
  Fatal = 1,
  Degraded = 2,
}
...
export declare class GoudError extends Error {
  ...
  constructor(code: number, message: string, category: string, subsystem: string, operation: string, recovery: number, recoveryHint: string);
