...
export class GoudGame implements IGoudGame {
  ...
  drawSpriteRect(texture: number, x: number, y: number, width: number, height: number, rotation = 0, srcX = 0, srcY = 0, srcW = 1, srcH = 1, color?: IColor, srcMode = 1): boolean {
    const c = color ?? Color.white();
    // WASM path only supports normalized UVs; srcMode is ignored
    return this.handle.draw_sprite_rect(texture, x, y, width, height, rotation, srcX, srcY, srcW, srcH, c.r, c.g, c.b, c.a);
  }
  /** Draws a batch of sprites (not yet supported on WASM target, returns 0). */
  ...
  p2pCreateMesh(_protocol: number, _port: number, _config: IP2pMeshConfig): number {
    throw new Error('P2P mesh is not supported in WASM mode');
  }
  p2pJoinMesh(_protocol: number, _address: string, _port: number, _config: IP2pMeshConfig): number {
    throw new Error('P2P mesh is not supported in WASM mode');
  }
  p2pLeaveMesh(_handle: number): number {
    throw new Error('P2P mesh is not supported in WASM mode');
  }
  p2pGetPeers(_handle: number): number {
    throw new Error('P2P mesh is not supported in WASM mode');
  }
  p2pGetHost(_handle: number): number {
    throw new Error('P2P mesh is not supported in WASM mode');
  }

  rollbackCreate(_config: IRollbackConfig, _localPlayer: number, _playerIds: Uint8Array, _statePtr: number, _advanceFn: number, _hashFn: number, _cloneFn: number, _freeFn: number): number {
    throw new Error('Rollback netcode is not supported in WASM mode');
  }
  rollbackDestroy(_handle: number): number {
    throw new Error('Rollback netcode is not supported in WASM mode');
  }
  rollbackAdvanceFrame(_handle: number, _input: Uint8Array): number {
    throw new Error('Rollback netcode is not supported in WASM mode');
  }
  rollbackReceiveRemoteInput(_handle: number, _playerId: number, _frame: number, _input: Uint8Array): number {
    throw new Error('Rollback netcode is not supported in WASM mode');
  }
  rollbackShouldRollback(_handle: number): number {
    throw new Error('Rollback netcode is not supported in WASM mode');
  }
  rollbackResimulate(_handle: number): number {
    throw new Error('Rollback netcode is not supported in WASM mode');
  }
  rollbackConfirmedFrame(_handle: number): number {
    throw new Error('Rollback netcode is not supported in WASM mode');
  }
  rollbackCurrentFrame(_handle: number): number {
    throw new Error('Rollback netcode is not supported in WASM mode');
  }
  rollbackCheckDesync(_handle: number, _remoteHash: number, _frame: number): number {
    throw new Error('Rollback netcode is not supported in WASM mode');
  }

  rpcCreate(_timeoutMs: number, _maxPayload: number): number {
    throw new Error('RPC framework is not supported in WASM mode');
  }
  rpcDestroy(_handle: number): number {
    throw new Error('RPC framework is not supported in WASM mode');
  }
  rpcRegister(_handle: number, _rpcId: number, _name: string, _direction: number): number {
    throw new Error('RPC framework is not supported in WASM mode');
  }
  rpcCall(_handle: number, _peerId: number, _rpcId: number, _payload: Uint8Array): number {
    throw new Error('RPC framework is not supported in WASM mode');
  }
  rpcPoll(_handle: number, _deltaSecs: number): number {
    throw new Error('RPC framework is not supported in WASM mode');
  }
  rpcProcessIncoming(_handle: number, _peerId: number, _data: Uint8Array): number {
    throw new Error('RPC framework is not supported in WASM mode');
  }
  rpcReceiveResponse(_handle: number, _callId: number): Uint8Array {
    throw new Error('RPC framework is not supported in WASM mode');
  }
  rpcDrainOne(_handle: number): Uint8Array {
    throw new Error('RPC framework is not supported in WASM mode');
  }
  ...
  getRenderMetrics(): IRenderMetrics { return { drawCallCount: 0, spritesSubmitted: 0, spritesDrawn: 0, spritesCulled: 0, batchesSubmitted: 0, avgSpritesPerBatch: 0, spriteRenderMs: 0, textRenderMs: 0, uiRenderMs: 0, totalRenderMs: 0, textDrawCalls: 0, textGlyphCount: 0, uiDrawCalls: 0 }; }
  getFramePhaseTimings(): IFramePhaseTimings { return { beginFrameUs: 0, endFrameUs: 0, surfaceAcquireUs: 0, shadowPassUs: 0, shadowBuildUs: 0, render3dSceneUs: 0, uniformUploadUs: 0, renderPassUs: 0, gpuSubmitUs: 0, readbackStallUs: 0, surfacePresentUs: 0, animEvalUs: 0, bonePackUs: 0, boneUploadUs: 0 }; }
  ...
  // Generic component operations (WASM stubs — full support tracked in #606)
  componentRegisterType(_typeIdHash: number, _name: string, _size: number, _align: number): boolean { throw new Error('Generic components not yet supported in WASM mode'); }
  componentAdd(_entity: IEntity, _typeIdHash: number, _dataPtr: number, _dataSize: number): boolean { throw new Error('Generic components not yet supported in WASM mode'); }
  componentRemove(_entity: IEntity, _typeIdHash: number): boolean { throw new Error('Generic components not yet supported in WASM mode'); }
  componentHas(_entity: IEntity, _typeIdHash: number): boolean { throw new Error('Generic components not yet supported in WASM mode'); }
  componentGet(_entity: IEntity, _typeIdHash: number): number { throw new Error('Generic components not yet supported in WASM mode'); }
  componentGetMut(_entity: IEntity, _typeIdHash: number): number { throw new Error('Generic components not yet supported in WASM mode'); }
  componentAddBatch(_entities: IEntity[], _typeIdHash: number, _dataPtr: number, _componentSize: number): number { throw new Error('Generic components not yet supported in WASM mode'); }
  componentRemoveBatch(_entities: IEntity[], _typeIdHash: number): number { throw new Error('Generic components not yet supported in WASM mode'); }
  componentHasBatch(_entities: IEntity[], _typeIdHash: number, _outResults: number[]): number { throw new Error('Generic components not yet supported in WASM mode'); }
  componentCount(_typeIdHash: number): number { throw new Error('Generic components not yet supported in WASM mode'); }
  componentGetEntities(_typeIdHash: number, _outEntities: number, _maxCount: number): number { throw new Error('Generic components not yet supported in WASM mode'); }
  componentGetAll(_typeIdHash: number, _outEntities: number, _outDataPtrs: number, _maxCount: number): number { throw new Error('Generic components not yet supported in WASM mode'); }
