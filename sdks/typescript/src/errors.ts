 ...
 *
 * Maps FFI error codes to language-idiomatic Error subclasses with
 * code, message, context, and recovery information. All recovery
 * logic lives in Rust; these classes only represent the data.
 */
