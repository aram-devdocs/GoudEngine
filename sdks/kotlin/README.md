...
```kotlin
dependencies {
    implementation("io.github.aram-devdocs:goudengine:0.0.839")
}
```
...
See the [Getting Started guide](../../docs/src/getting-started/kotlin.md) for installation, project setup, and examples.
